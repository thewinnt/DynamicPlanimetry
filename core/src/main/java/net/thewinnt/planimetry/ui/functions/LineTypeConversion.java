...
public class LineTypeConversion extends Function<Line> {
    ...
    public WidgetGroup setupActors(StyleSet styles) {
        ...
        SelectBox<LineType> selector = new SelectBox<>(styles.getListStyle(Size.MEDIUM));
        selector.setItems(LineType.values());
        ...
        TextButton apply = new TextButton("Применить", styles.getButtonStyle(Size.MEDIUM, true));
        ...
        table.add(new Label("Преобразовать в ", styles.getLabelStyle(Size.MEDIUM)));
