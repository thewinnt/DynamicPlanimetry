...
public class CreateParallelLine extends BasicNamedFunction<Line> {
    private static final Component NAME = Component.translatable("function.generic_line.create_parallel");
    ...
    public CreateParallelLine(Drawing drawing, Line shape) {
        super(
            ...
            NAME,
            Component.translatable("function.generic_line.create_parallel.action")
        );
